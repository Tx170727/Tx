...
public class TPayLogServiceImpl extends ServiceImpl<TPayLogMapper, TPayLog> implements TPayLogService {
    ...
    //生成微信支付二维码接口
    @Override
    public Map createNavite(String orderNo) {
        try {
            //1 根据订单号查询订单信息
            ...
            HttpClientUtils.get("https://api.mch.weixin.qq.com/pay/unifiedorder");
            //设置xml格式的参数
