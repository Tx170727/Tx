      ...
      <section class="c-sort-box">
        <section class="c-s-dl">
          <dl>
            ...
            <dd class="c-s-dl-li">
              <ul class="clearfix">
                <li>
                  <a title="全部" href="#" @click="returnCourseFirst">全部</a>
                </li>
        ...
        <div class="mt40">
          ...
          <article  v-if="data.total>0" class="comm-course-list">
            <ul class="of" id="bna">
              <li v-for="item in data.record" :key="item.id">
                <div class="cc-l-wrap">
...
export default {
  ...
  methods:{
    //1 查询第一页数据
    initCourseFirst() {
      courseApi.getCourseList(this.searchObj,1).then(response => {
    ...
    //3 分页切换的方法
    gotoPage(page) {
      courseApi.getCourseList(this.searchObj,page).then(response => {
        this.data = response.data.data
        this.total=response.data.data.total
        this.current=response.data.data.current
        console.log(this.current)
